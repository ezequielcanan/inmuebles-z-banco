...
const Login = () => {
  ...
  return (
    <Main className={"bg-gradient-to-tr from-green-700 to-teal-300 grid items-center justify-items-center overflow-hidden !py-[200px] px-[10px]"}>
      <div className="bg-primary flex flex-col gap-y-[100px] items-center w-auto py-3 px-3 md:py-7 md:px-7">
        ...
        <Form className={"gap-y-[70px] w-full"} onSubmit={onSubmit}>
          ...
          <div className="flex flex-col gap-y-[30px]">
            ...
            <div className="flex justify-between w-full text-white text-lg md:text-2xl items-center">
              ...
              <Link to={"/register"} className="bg-cyan-700 py-2 px-3">Registrate</Link>
            </div>
